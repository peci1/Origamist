...
\item \emph{Technical origami}, which develops the models based on computer-generated crease patterns\footnote{More on crease patterns can be found further in the text}. \cite{mobilereference}. %TODO make a link from the footnote
