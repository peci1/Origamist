 ...
 * @author Martin Pecka
 */
public class PDFExportOptions implements ExportOptions
{
    /** Dpi of the paper. */
     ...
     */
    public PDFExportOptions(double dpi, Locale locale, Insets pageInsets, boolean withBackground)
    {
        this.dpi = dpi;
        this.locale = locale;
     ...
     * @param insets The insets of the page in pixels.
     */
    public PDFExportOptions(double dpi, Locale locale, Insets pageInsets)
    {
        this.dpi = dpi;
        this.locale = locale;
        this.pageInsets = pageInsets;
     ...
     * @param locale Locale of the step descriptions.
     */
    public PDFExportOptions(double dpi, Locale locale)
    {
        this.dpi = dpi;
        this.locale = locale;
    }
     ...
     * @param insets The insets of the page in pixels.
     */
    public PDFExportOptions(double dpi, Insets pageInsets)
    {
        this.dpi = dpi;
        this.pageInsets = pageInsets;
    }
     ...
     * @param insets The insets of the page in pixels.
     */
    public PDFExportOptions(Locale locale, Insets pageInsets)
    {
        this.locale = locale;
        this.pageInsets = pageInsets;
    }
     ...
     * @param dpi The dots per inch value of the exported paper.
     */
    public PDFExportOptions(double dpi)
    {
        this.dpi = dpi;
    }
     ...
     * @param locale Locale of the step descriptions.
     */
    public PDFExportOptions(Locale locale)
    {
        this.locale = locale;
    }
     ...
     * @param insets The insets of the page in pixels.
     */
    public PDFExportOptions(Insets pageInsets)
    {
        this.pageInsets = pageInsets;
    }
