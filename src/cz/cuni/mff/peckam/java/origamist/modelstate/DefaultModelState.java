...
public class DefaultModelState extends ModelState
{
    ...
    public DefaultModelState(Origami o)
    {
        ...
        ModelTriangle mt1 = new ModelTriangle(dl.x, dl.y, 0, dr.x, dr.y, 0, ul.x, ul.y, 0, new Triangle2d(dl.x, dl.y,
                dr.x, dr.y, ul.x, ul.y));
        triangles.add(mt1);

        ModelTriangle mt2 = new ModelTriangle(ur.x, ur.y, 0, ul.x, ul.y, 0, dr.x, dr.y, 0, new Triangle2d(ur.x, ur.y,
                ul.x, ul.y, dr.x, dr.y));
        triangles.add(mt2);
