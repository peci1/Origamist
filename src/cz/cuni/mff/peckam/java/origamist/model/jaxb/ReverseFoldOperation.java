    ...
    implements Equals, HashCode
{
     ...
     * 
     */
    public final static String LINE_PROPERTY = "line:cz.cuni.mff.peckam.java.origamist.model.jaxb.ReverseFoldOperation";
    protected cz.cuni.mff.peckam.java.origamist.model.Line2D refLine;
    /**
     * Property refLine
     * 
     */
    public final static String REF_LINE_PROPERTY = "refLine:cz.cuni.mff.peckam.java.origamist.model.jaxb.ReverseFoldOperation";
     ...
     * 
     */
    public final static String OPPOSITE_LINE_PROPERTY = "oppositeLine:cz.cuni.mff.peckam.java.origamist.model.jaxb.ReverseFoldOperation";
    protected List<Integer> oppositeLayer = new cz.cuni.mff.peckam.java.origamist.utils.ObservableList<Integer>();
    /**
     * Property layer
     * 
     */
    public final static String LAYER_PROPERTY = "layer:cz.cuni.mff.peckam.java.origamist.model.jaxb.ReverseFoldOperation";
    /**
     * Property oppositeLayer
     * 
     */
    public final static String OPPOSITE_LAYER_PROPERTY = "oppositeLayer:cz.cuni.mff.peckam.java.origamist.model.jaxb.ReverseFoldOperation";

    public ReverseFoldOperation() {
        if (getClass().getName().equals("cz.cuni.mff.peckam.java.origamist.model.ReverseFoldOperation")) {
            init();
        }
    }
    ...
    public void setLine(cz.cuni.mff.peckam.java.origamist.model.Line2D value) {
        ...
        if (((old!= value)&&((old == null)||(value == null)))||((old!= null)&&(!old.equals(value)))) {
            support.firePropertyChange(ReverseFoldOperation.LINE_PROPERTY, old, value);
        }
    }
    ...
    public void setRefLine(cz.cuni.mff.peckam.java.origamist.model.Line2D value) {
        ...
        if (((old!= value)&&((old == null)||(value == null)))||((old!= null)&&(!old.equals(value)))) {
            support.firePropertyChange(ReverseFoldOperation.REF_LINE_PROPERTY, old, value);
        }
    }
    ...
    public void setOppositeLine(cz.cuni.mff.peckam.java.origamist.model.Line2D value) {
        ...
        if (((old!= value)&&((old == null)||(value == null)))||((old!= null)&&(!old.equals(value)))) {
            support.firePropertyChange(ReverseFoldOperation.OPPOSITE_LINE_PROPERTY, old, value);
        }
    }
    ...
    public List<?> [] getListFields() {
        return new List<?> [] {getLayer(), getOppositeLayer()};
    }
    ...
    public String[] getListProperties() {
        return new String[] {LAYER_PROPERTY, OPPOSITE_LAYER_PROPERTY };
    }
