 ...
 *               &lt;element name="thunderboltFoldOperation" type="{http://www.mff.cuni.cz/~peckam/java/origamist/diagram/v2}ThunderboltFoldOperation"/>
 *               &lt;element name="crimpFoldOperation" type="{http://www.mff.cuni.cz/~peckam/java/origamist/diagram/v2}CrimpFoldOperation"/>
 *               &lt;element name="markerOpertaion" type="{http://www.mff.cuni.cz/~peckam/java/origamist/diagram/v2}MarkerOperation"/>
 *             &lt;/choice>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
...
public class Step implements HasBoundProperties, Equals, HashCode
{
     ...
     * 
     */
    public final static String COLSPAN_PROPERTY = "colspan";
    @XmlElement(type = String.class, defaultValue = "1")
    @XmlJavaTypeAdapter(Adapter1 .class)
     ...
     * 
     */
    public final static String ROWSPAN_PROPERTY = "rowspan";
    ...
    @XmlElements({
        ...
        @XmlElement(name = "markerOpertaion", type = cz.cuni.mff.peckam.java.origamist.model.MarkerOperation.class),
