    ...
    implements Equals, HashCode
{
     ...
     * 
     */
    public final static String SECOND_LAYER_PROPERTY = "secondLayer:cz.cuni.mff.peckam.java.origamist.model.jaxb.CrimpFoldOperation";
    /**
    ...
    public List<?> [] getListFields() {
        return new List<?> [] {getLayer(), getOppositeLayer(), getSecondLayer(), getSecondOppositeLayer()};
    }
    ...
    public String[] getListProperties() {
        return new String[] {LAYER_PROPERTY, OPPOSITE_LAYER_PROPERTY, SECOND_LAYER_PROPERTY, SECOND_OPPOSITE_LAYER_PROPERTY };
    }
