...
public class ObjectFactory {
    ...
    private final static QName _Origami_QNAME = new QName("http://www.mff.cuni.cz/~peckam/java/origamist/diagram/v1", "origami");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.mff.cuni.cz/~peckam/java/origamist/diagram/v1", name = "origami")
    @SuppressWarnings({
        "rawtypes",
        "unchecked"
    })
